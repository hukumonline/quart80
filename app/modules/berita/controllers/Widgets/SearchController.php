<?php
class Berita_Widgets_SearchController extends Zend_Controller_Action
{
	/*
	...
	function viewResultClinicAction()
	{
		$time_start = microtime(true);
	...
	*/
	function viewResultArticleAction()
	{
		$time_start = microtime(true);
		...
		$querynum = $query.' profile:article';
